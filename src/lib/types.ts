...
export interface Score {
  ...
  oreo_drive_min: number | null;
  sugar_cookie_transit_min: number | null;
  sugar_cookie_walk_min: number | null;
  sugar_cookie_transfers: number | null;
  sugar_cookie_transit_route: string | null;
